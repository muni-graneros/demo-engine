 ...
 *
 * @param {Array<{escena:string,actor:string,tLocal:number,tGlobal:number,duracionMs:number,narrar?:string}>} pasos
 * @returns {Array<{actor:string,escena:string,desdeSeg:number,hastaSeg:number,tGlobal:number,narrar?:string}>}
 */
